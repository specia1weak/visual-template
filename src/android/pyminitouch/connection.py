...
from .config import MNT_PREBUILT_URL
...
class MNTInstaller(object):
    ...
    def download_target_mnt(self):
        abi = self.get_abi()
        # target_url = "{}/{}/bin/minitouch".format(config.MNT_PREBUILT_URL, abi) # github的某个路径 # 我的realme是arm64-v8a
        #"https://github.com/williamfzc/stf-binaries/raw/master/node_modules/minitouch-prebuilt/prebuilt/arm64-v8a/bin/minitouch"
